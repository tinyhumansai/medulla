...
datagram. On the forwarder path it is fixed at enrollment (§7.2); on the
...
that already happened. Where that assumption does not hold, use the forwarder path's TTY prompt
