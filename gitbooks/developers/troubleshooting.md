...
| Path | Contents |
| --- | --- |
| [`src/sdk/src/clipboard/`](../../src/sdk/src/clipboard/) | The routes themselves. `tmux.rs` holds the passthrough wrapper, the `load-buffer` hop, and the OSC 52 parameter parsing. |
