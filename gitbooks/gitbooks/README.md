...
* [Why an Orchestrator](overview/why-an-orchestrator-model.md): the failure mode of chat-first orchestration, and what an orchestrator does differently.
* [Context Scaling Without Collapse](overview/rlm-context-scaling.md): how the reasoning surface stays small while the fleet grows.
* [Pricing and Availability](overview/pricing-and-availability.md): pricing, early alpha, and how to request access.
...
Building on Medulla? The [Developers](developers/developers.md) section covers installing the [TUI](developers/getting-started.md), embedding the [SDK](developers/architecture.md), and wiring your own fleet to the orchestrator.
