...
- [`roster/`](./roster/) — Tests for the hub roster: how a worker is advertised, addressed, and kept unique — split into `strategy`, `advert`, `dedupe`, `roles` and `topology`, with shared fixtures in `helpers`.
