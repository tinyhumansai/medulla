...
//! `runtime_impl` carries the [`Runtime`] trait implementation and `scenario`
//! scripts the populated demo world. The public surface is re-exported here so
//! callers use `medulla::runtime::mock::MockRuntime`.
//!
