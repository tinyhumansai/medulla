...
- [`summary.rs`](./summary.rs) — Reading a session file's head window and distilling it into a `SessionSummary`: the session id, recorded cwd, and a display label slugged from the first human prompt.
