...
impl TurnWatcher {
    ...
    pub fn observe(&mut self, raw: &str) -> Option<TurnSignal> {
        ...
        match self.provider {
            ...
            HarnessProvider::Opencode | HarnessProvider::Openhuman | HarnessProvider::Shell => None,
        }
    }
...
mod types;
use types::PendingTerminal;
pub use types::TurnSignal;
pub use types::TurnWatcher;
