...
pub struct SessionConfig {
    ...
    /// Optional custom OpenAI-compatible router, layered into every turn's spawn
    /// environment so interactive sessions route exactly like headless tasks.
    /// `None` means routing is off.
