...
fn fixture(id: &str) -> (tempfile::TempDir, Arc<dyn WorkflowStore>, RunRecord) {
...
fn session(store: Arc<dyn WorkflowStore>, dispatch: Arc<dyn HarnessDispatch>) -> EvolveSession {
    EvolveSession {
        store,
        dispatch,
...
fn silent(store: &Arc<dyn WorkflowStore>, reply: &str) -> Arc<dyn HarnessDispatch> {
