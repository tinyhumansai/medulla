...
fn timeout_falls_back_when_unset_or_garbage() {
    assert_eq!(
        resolve_timeout_s(&env(&[]), &medulla::hub::stderr_log()),
        DEFAULT_TASK_TIMEOUT_S
    );
    assert_eq!(
        resolve_timeout_s(
            &env(&[("MEDULLA_HUB_TASK_TIMEOUT_S", "not-a-number")]),
    ...
    assert_eq!(
        resolve_timeout_s(
            &env(&[("MEDULLA_HUB_TASK_TIMEOUT_S", "0")]),
            &medulla::hub::stderr_log()
        ),
        DEFAULT_TASK_TIMEOUT_S
    );
...
fn timeout_is_capped_below_the_backend_ceiling() {
    ...
    assert_eq!(
        resolve_timeout_s(
            &env(&[("MEDULLA_HUB_TASK_TIMEOUT_S", "120")]),
            &medulla::hub::stderr_log()
        ),
        120
    );
    ...
    assert_eq!(
        resolve_timeout_s(
            &env(&[("MEDULLA_HUB_TASK_TIMEOUT_S", "300")]),
            &medulla::hub::stderr_log()
        ),
        MAX_TASK_TIMEOUT_S
    );
    assert_eq!(
        resolve_timeout_s(
            &env(&[("MEDULLA_HUB_TASK_TIMEOUT_S", "6000")]),
            &medulla::hub::stderr_log()
        ),
        MAX_TASK_TIMEOUT_S
    );
